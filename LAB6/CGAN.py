...
import json
import evaluator
from evaluator import evaluation_model as eval_model
...
def get_data():
    ...
    TRAIN_FILE_PATH = "D:/user/Desktop/DL_LAB6/dataset/train.json"
    OBJECTS_FILE_PATH = "D:/user/Desktop/DL_LAB6/dataset/objects.json"
...
# Load data
IMAGE_ROOT_PATH = "D:/user/Desktop/DL_LAB6/iclevr/"
...
save_weight_dir = 'D:/user/Desktop/IMVFX hw/checkpoint_landscape'
...
def get_test_onehot():
    # Read test labels
    TEST_FILE_PATH = "D:/user/Desktop/DL_LAB6/dataset/test.json"
...
def eval_GAN():
    with torch.no_grad():
        model_name = "netG_epoch_280"
        EVAL_PATH = "D:/user/Desktop/DL_LAB6/checkpoint/" + model_name + ".pth"
